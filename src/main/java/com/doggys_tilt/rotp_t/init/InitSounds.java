...
public class InitSounds {
    ...
    public static final OstSoundList TUSK_OST = new OstSoundList(
            new ResourceLocation(AddonMain.MOD_ID, "tusk_ost"), SOUNDS);
}
